...
add_window.configure(bg="yellow")
f=("Arial",20,"bold")
aw_lbl_rno=Label(add_window,text="enter rno",font=f,bg="yellow")
aw_lbl_rno.place(x=100,y=20)
aw_lbl_rno=Label(add_window,text="enter name",font=f,bg="yellow")
aw_lbl_rno.place(x=100,y=120)
aw_lbl_rno=Label(add_window,text="enter marks",font=f,bg="yellow")
...
uw_btn_save=Button(update_window,text="Back",font=f,bd=3,command=f2)
uw_btn_save.place(x=360,y=500)
update_window.withdraw()
