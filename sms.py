...
def f7():
	...
	main_window.withdraw();	st_data.delete("1.0",END)
	con=None
	try:
		con=connect("sms.db")
		cursor=con.cursor()
...
main_window.protocol('WM_DELETE_WINDOW',on_close)	#exit yes or no
...
btnPlot=Button(main_window,text="Plot",font=f,bd=3,command=f12)
